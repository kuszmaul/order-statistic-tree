...
class OstSetNode : public RawNode<Key, Key, Compare, OstSetNode<Key, Compare>> {
...
class OrderStatisticSet
    : public cachelib_internal::RawOrderStatisticSet<
          Key, Key, Compare, cachelib_internal::OstSetNode<Key, Compare>> {
 private:
 ...
 public:
  ...
  // void clear() const;
  //
  // Erases all the elements from the container.
  using Base::clear;
